...
require (
	...
	github.com/kubernetes-sigs/aws-ebs-csi-driver v1.55.0
...
require (
	...
	github.com/awslabs/volume-modifier-for-k8s v0.9.1 // indirect
	...
	github.com/kubernetes-csi/csi-proxy/v2 v2.0.0-alpha.2 // indirect
